...
import gooten.api.client.auth.Authentication;
import gooten.api.client.auth.ApiKeyAuth;
import gooten.api.client.auth.HttpBasicAuth;
import gooten.api.client.request.GetRequest;
import gooten.api.client.request.PostRequest;
import gooten.api.client.request.PutRequest;
import gooten.api.client.request.DeleteRequest;
import gooten.api.client.request.PatchRequest;
