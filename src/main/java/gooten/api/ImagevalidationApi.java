...
public class ImagevalidationApi {
  ...
  */
  public ImageValidatorResult pOSTImagevalidation (ImageValidationVm req) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
     Object postBody = req;
  
      // verify the required parameter 'req' is set
      if (req == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'req' when calling pOSTImagevalidation",
      new ApiException(400, "Missing the required parameter 'req' when calling pOSTImagevalidation"));
      }
  

  // create path and map variables
  String path = "/imagevalidation/".replaceAll("\\{format\\}","json");
   ...
   * @param req Image validation request, contains sku and image sizes per space
  */
  public void pOSTImagevalidation (ImageValidationVm req, final Response.Listener<ImageValidatorResult> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = req;
      ...
      apiInvoker.invokeAPI(basePath, path, "POST", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            ...
            try {
              responseListener.onResponse((ImageValidatorResult) ApiInvoker.deserialize(localVarResponse,  "", ImageValidatorResult.class));
